...
![image alt <](image/interface/services-menu.png){ width="20%" }
...
![image alt <](image/interface/reports-menu.png){ width="20%" }
...
![image alt >](image/interface/datacollection-menu.png){ width="20%" }
